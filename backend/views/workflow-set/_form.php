...
<?php $form = ActiveForm::begin([
        ...
        <div class="form-group">
            ...
            <div class="radio inline">
                <label>
                    <input name="FlowItem[free_other]" value="1" type="radio" class="ace" <?php if(!$model->isNewRecord && $model->free_other == 1) echo 'checked'; ?> />
                    <span class="lbl"> <?=Yii::t('app','Yes')?></span>
                </label>
            </div>
            <div class="radio inline">
                <label>
                    <input name="FlowItem[free_other]" value="0" type="radio" class="ace" <?php if($model->isNewRecord){ echo 'checked';}else{if($model->free_other == 0) echo 'checked';}?> />
        ...
        <div class="form-group">
            ...
            <div class="radio inline">
                <label>
                    <input name="FlowItem[free_other]" value="0" type="radio" class="ace" <?php if(!$model->isNewRecord && $model->free_other == 0) echo 'checked'; ?> />
                    <span class="lbl"> <?=Yii::t('app','No')?></span>
                </label>
            </div>
        </div>   
        ...
        <?= $form->field($model, 'sort_no')->textInput(['class'=>'col-xs-12','value'=>100]) ?>
        <?= $form->field($model, 'auto_name')->textArea(['class'=>'col-xs-12']) ?>
        <?= $form->field($model, 'auto_field')->textArea(['class'=>'col-xs-12']) ?>
        <?= $form->field($model, 'auto_len')->textInput(['class'=>'col-xs-12', 'value'=>10]) ?>
        <div class="form-group">
            <label class="col-sm-2 control-label no-padding-right"><?=Yii::t('app','Is Auto')?></label>
            <div class="radio inline">
                <label>
                    <input name="FlowItem[is_auto]" value="1" type="radio" class="ace" <?php if(!$model->isNewRecord && $model->is_auto == 1) echo 'checked'; ?> />
                    <span class="lbl"> <?=Yii::t('app','Yes')?></span>
                </label>
            </div>
            <div class="radio inline">
                <label>
                    <input name="FlowItem[is_auto]" value="0" type="radio" class="ace" <?php if($model->isNewRecord){ echo 'checked';}else{if($model->is_auto == 0) echo 'checked';}?> />
                    <span class="lbl"> <?=Yii::t('app','No')?></span>
                </label>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="radio inline">
                <label>
                    <input name="FlowItem[view_priv]" value="1" type="radio" class="ace" <?php if($model->isNewRecord){ echo 'checked';}else{if($model->view_priv == 1) echo 'checked';}?> />
                    <span class="lbl"> <?=Yii::t('app','Enable')?></span>
                </label>
            </div>
            <div class="radio inline">
                <label>
                    <input name="FlowItem[view_priv]" value="0" type="radio" class="ace" <?php if(!$model->isNewRecord && $model->view_priv == 0 ) echo 'checked'; ?> />
                    <span class="lbl"> <?=Yii::t('app','Disable')?></span>
                </label>
            </div>

        </div>
        <?= $form->field($model, 'view_user')->textArea(['class'=>'col-xs-12']) ?>        
